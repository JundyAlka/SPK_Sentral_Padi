...
<?php $__env->startSection('content'); ?>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <!-- Alternatif Card -->
        <!-- Alternatif Card -->
        <a href="<?php echo e(route('admin.daerah.index')); ?>" class="group transform hover:-translate-y-1 transition-all duration-300">
        ...
        <!-- Kriteria Card -->
        <!-- Kriteria Card -->
        <a href="<?php echo e(route('admin.kriteria.index')); ?>" class="group transform hover:-translate-y-1 transition-all duration-300">
        ...
        <!-- Users Card -->
        <!-- Users Card -->
        <a href="<?php echo e(route('admin.user.index')); ?>" class="group transform hover:-translate-y-1 transition-all duration-300">
