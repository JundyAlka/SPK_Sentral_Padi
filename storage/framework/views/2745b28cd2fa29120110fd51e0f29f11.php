        ...
        <div class="relative z-10 px-8 py-10 w-full flex items-center justify-between">
            <div class="max-w-2xl text-white">
                ...
                <div class="flex gap-4">
                    <a href="<?php echo e(route('admin.daerah.create')); ?>" class="inline-flex items-center px-6 py-3 border border-transparent text-base font-bold rounded-full text-emerald-900 bg-white hover:bg-gray-100 shadow-lg transform transition hover:-translate-y-1">
        ...
        <div class="space-y-8">
             ...
             <div class="bg-white rounded-lg shadow p-6">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <a href="<?php echo e(route('admin.kriteria.index')); ?>" class="flex flex-col items-center justify-center p-4 border rounded-lg hover:bg-emerald-50 hover:border-emerald-200 transition group cursor-pointer">
