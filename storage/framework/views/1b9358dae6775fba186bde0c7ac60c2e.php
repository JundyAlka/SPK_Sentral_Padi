...
<?php $__env->startSection('title', 'Edit Data Alternatif'); ?>

<?php $__env->startSection('content'); ?>
<div class="max-w-2xl mx-auto">
    <h1 class="text-2xl font-bold text-gray-900 mb-6">Edit Data Alternatif</h1>

    <form action="<?php echo e(route('admin.daerah.update', ['daerah' => $daerah->id])); ?>" method="POST" class="space-y-6">
        <?php echo csrf_field(); ?>
        ...
        <div>
            ...
            <select id="provinsi" name="provinsi" required class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent">
                ...
                <option value="DKI Jakarta" <?php echo e($daerah->provinsi == 'DKI Jakarta' ? 'selected' : ''); ?>>DKI Jakarta</option>
                <option value="Jawa Barat" <?php echo e($daerah->provinsi == 'Jawa Barat' ? 'selected' : ''); ?>>Jawa Barat</option>
                <option value="Jawa Tengah" <?php echo e($daerah->provinsi == 'Jawa Tengah' ? 'selected' : ''); ?>>Jawa Tengah</option>
                <option value="DI Yogyakarta" <?php echo e($daerah->provinsi == 'DI Yogyakarta' ? 'selected' : ''); ?>>DI Yogyakarta</option>
                <option value="Jawa Timur" <?php echo e($daerah->provinsi == 'Jawa Timur' ? 'selected' : ''); ?>>Jawa Timur</option>
                <option value="Banten" <?php echo e($daerah->provinsi == 'Banten' ? 'selected' : ''); ?>>Banten</option>
            </select>
        </div>
        ...
        <div>
            ...
            <select id="nama_daerah" name="nama_daerah" required class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent">
                <option value="<?php echo e($daerah->nama_daerah); ?>"><?php echo e($daerah->nama_daerah); ?></option>
            </select>
        </div>

        <div class="flex items-center justify-end gap-4 pt-4">
            <a href="<?php echo e(route('admin.daerah.index')); ?>" class="px-6 py-3 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50">
                Batal
            </a>
...
const currentCity = '<?php echo e($daerah->nama_daerah); ?>';
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Website\spk_sentral_padi\resources\views/admin/daerah/edit.blade.php ENDPATH**/ ?>