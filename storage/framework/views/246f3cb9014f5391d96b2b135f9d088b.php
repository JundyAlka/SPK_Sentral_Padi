        ...
        <div class="relative z-10 px-8 py-10 w-full flex items-center justify-between">
            <div class="max-w-2xl text-white">
                ...
                <div class="flex gap-4">
                    <a href="<?php echo e(route('user.analisis.index')); ?>" class="inline-flex items-center px-6 py-3 border border-transparent text-base font-bold rounded-full text-emerald-900 bg-yellow-400 hover:bg-yellow-300 shadow-lg transform transition hover:-translate-y-1 hover:shadow-yellow-400/50">
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900"><?php echo e($kriteria->nama_kriteria); ?></td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="px-2 py-1 text-xs font-semibold rounded-full <?php echo e($kriteria->jenis == 'benefit' ? 'bg-blue-100 text-blue-800' : 'bg-red-100 text-red-800'); ?>">
                                    <?php echo e($kriteria->jenis == 'benefit' ? 'Keuntungan' : 'Biaya'); ?>
