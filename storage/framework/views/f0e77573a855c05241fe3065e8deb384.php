...
<?php $__env->startSection('title', 'Analisis SPK'); ?>
    ...
    <div class="lg:col-span-1">
        <div class="bg-white shadow sm:rounded-lg">
            <div class="px-4 py-5 sm:p-6">
                ...
                <form action="<?php echo e(route('user.analisis.proses')); ?>" method="POST" class="mt-5">
                    <?php echo csrf_field(); ?>
                    <div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Website\spk_sentral_padi\resources\views/user/analisis/index.blade.php ENDPATH**/ ?>