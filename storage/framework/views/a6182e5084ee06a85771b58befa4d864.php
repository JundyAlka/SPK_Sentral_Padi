...
<?php $__env->startSection('title', 'Tambah Data Alternatif'); ?>

<?php $__env->startSection('content'); ?>
<div class="max-w-2xl mx-auto">
    <h1 class="text-2xl font-bold text-gray-900 mb-6">Tambah Data Alternatif Baru</h1>

    <form action="<?php echo e(route('admin.daerah.store')); ?>" method="POST" class="space-y-6">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Website\spk_sentral_padi\resources\views/admin/daerah/create.blade.php ENDPATH**/ ?>