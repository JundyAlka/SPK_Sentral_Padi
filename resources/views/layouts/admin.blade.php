        ...
        <div id="admin-sidebar" class="hidden md:flex flex-col w-64 bg-emerald-900 border-r-4 border-yellow-500 sidebar-transition relative z-20 shadow-2xl">
            ...
            <div class="flex-1 flex flex-col overflow-y-auto overflow-x-hidden bg-gradient-to-b from-emerald-900 to-emerald-950">
                <nav class="flex-1 px-3 py-6 space-y-2">
                    ...
                    <a href="{{ route('admin.perhitungan.index') }}" class="{{ request()->routeIs('admin.perhitungan.*') ? 'bg-emerald-800 text-white border-l-4 border-yellow-500 shadow-md' : 'text-emerald-300 hover:bg-emerald-800/50 hover:text-white' }} group flex items-center px-3 py-3 text-sm font-medium rounded-r-md transition-all duration-200 whitespace-nowrap mb-1">
                        <svg class="mr-3 flex-shrink-0 h-5 w-5 {{ request()->routeIs('admin.perhitungan.*') ? 'text-yellow-400' : 'text-emerald-500 group-hover:text-yellow-400' }} transition-colors" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z" />
                        </svg>
                        <span class="sidebar-text">Data Perhitungan</span>
                    </a>

                    <a href="{{ route('admin.hasil.index') }}" class="{{ request()->routeIs('admin.hasil.*') ? 'bg-emerald-800 text-white border-l-4 border-yellow-500 shadow-md' : 'text-emerald-300 hover:bg-emerald-800/50 hover:text-white' }} group flex items-center px-3 py-3 text-sm font-medium rounded-r-md transition-all duration-200 whitespace-nowrap mb-1">
                        <svg class="mr-3 flex-shrink-0 h-5 w-5 {{ request()->routeIs('admin.hasil.*') ? 'text-yellow-400' : 'text-emerald-500 group-hover:text-yellow-400' }} transition-colors" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <a href="{{ route('admin.user.index') }}" class="{{ request()->routeIs('admin.user.*') ? 'bg-emerald-800 text-white border-l-4 border-yellow-500 shadow-md' : 'text-emerald-300 hover:bg-emerald-800/50 hover:text-white' }} group flex items-center px-3 py-3 text-sm font-medium rounded-r-md transition-all duration-200 whitespace-nowrap mb-1">
                       <svg class="mr-3 flex-shrink-0 h-5 w-5 {{ request()->routeIs('admin.user.*') ? 'text-yellow-400' : 'text-emerald-500 group-hover:text-yellow-400' }} transition-colors" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
                        </svg>
                        <span class="sidebar-text">Data User</span>
                    </a>

                    <a href="{{ route('admin.profile.edit') }}" class="{{ request()->routeIs('admin.profile.*') ? 'bg-emerald-800 text-white border-l-4 border-yellow-500 shadow-md' : 'text-emerald-300 hover:bg-emerald-800/50 hover:text-white' }} group flex items-center px-3 py-3 text-sm font-medium rounded-r-md transition-all duration-200 whitespace-nowrap mb-1">
                        <svg class="mr-3 flex-shrink-0 h-5 w-5 {{ request()->routeIs('admin.profile.*') ? 'text-yellow-400' : 'text-emerald-500 group-hover:text-yellow-400' }} transition-colors" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
