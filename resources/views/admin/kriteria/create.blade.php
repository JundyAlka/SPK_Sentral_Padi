                ...
                <form action="{{ route('admin.kriteria.store') }}" method="POST">
                    ...
                    <div class="grid grid-cols-6 gap-6">
                        <div class="col-span-6">
                            ...
                            <input type="text" name="nama_kriteria" id="nama_kriteria" required class="mt-1 focus:ring-green-500 focus:border-green-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        </div>
