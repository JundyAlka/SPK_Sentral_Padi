...
@section('title', 'Input Nilai Daerah')

@section('content')
<div class="max-w-3xl mx-auto">
    <div class="bg-white shadow sm:rounded-lg">
        <div class="px-4 py-5 sm:p-6">
            <h3 class="text-lg leading-6 font-medium text-gray-900">Input Nilai Kriteria: {{ $daerah->nama_daerah }}</h3>
            ...
            <div class="mt-5">
                <form action="{{ route('admin.daerah.nilai.store', $daerah->id) }}" method="POST">
                    ...
                    <div class="mt-6 flex items-center justify-end">
                        <a href="{{ route('admin.daerah.index') }}" class="text-sm font-medium text-gray-700 hover:text-gray-500 mr-4">Batal</a>
